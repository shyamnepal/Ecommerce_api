...
namespace Ecommerce_shoes.Controllers
{
    ...
    public class Account : ControllerBase
    {
        ...
        public async Task<IActionResult> UserRegister(UserViewModel model)
        {
            ...
            var response = await _acountService.UserRegister(model, "User");
            return Ok(response);
        }
        ...
        public async Task<IActionResult> ForgetPassword(ForgetPasswordViewModel forgetPasswordModel)
        {
            ...
            {
                errorResponse.Status = "Failed";
                errorResponse.Errormessage = "please enter email";
                return BadRequest(errorResponse);
            }
            ...
            {
                errorResponse.Status = "Failed";
                errorResponse.Errormessage = "email is invalid";
                return BadRequest(errorResponse); 
            }
            ...
            errorResponse.Errormessage = "reset link is sent to your email";
        ...
        public async Task<IActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            {
                errorResponse.Status = "Failed";
                errorResponse.Errormessage = "please fill the form";
                return BadRequest(errorResponse);
            }
            ...
            {
                errorResponse.Status = "Failed";
                errorResponse.Errormessage = "User not found";
                return BadRequest(errorResponse);
            }
            // Decode the token
            ...
            {
                errorResponse.Status = "Failed";
                errorResponse.Errormessage = "Failed reset password";
                return BadRequest(errorResponse);
            }
            errorResponse.Status = "success";
            errorResponse.Errormessage = "Successfully reset password";
            errorResponse.ErrorCode = int.Parse(_config["Response:SuccessCode"]);
            return Ok(errorResponse);
